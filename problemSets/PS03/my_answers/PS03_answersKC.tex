...
(Intercept)      difflog  
    0.57903      0.04167  
		...
		\begin{figure} [h]
		\centering	\includegraphics[width=0.88\textwidth]{Question_1_scatterplot.jpeg}
		\end{figure}
...
(Intercept)      difflog  
    0.50758      0.02384  
		...
		\noindent In the equation, Y-hat represents the predicted value of vote share of the presidential candidate of the incumbent party, and X represents the difference between incumbent's and challenger's spending.
...
\end{figure}
	...
	\noindent The numbers representing the slope and y-intercept are taken from the linear regression run in R.
		...
		\noindent In the equation, Y-hat represents the predicted value of the vote share of the president candidate of the incumbent party, and X represents the incumbent's electoral success.
...
(Intercept)      difflog     presvote  
    0.44864      0.03554      0.25688 
		...
		\noindent The residuals from Question 1 represent the part of voteshare that cannot be linearly explained by difflog. The residuals from Question 2 represent the presvote that cannot be linearly explained by difflog. In Question 4, we are looking for a linear relationship between the 2 residuals and we got the coefficient 0.25688, which represents the impact of presvote on vote share if you take out the affect of difflog on presvote and take out the impact of difflog on vote share. In Question 5, 0.25688 represents the impact of presvote on voteshare, assuming that difflog and presvote are uncorrelated. Therefore, since in both cases the variable represents the impact of presvote on voteshare with no impact of difflog, the coefficients are the same. Following this logic, if I were to do a summary of the linear regressions, it would show that the standard errors are also the same.
