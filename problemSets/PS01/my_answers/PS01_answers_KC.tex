...
\noindent \underline{Step 6}: Calculate the lower limit of the confidence interval by doing the sample mean - (the absolute value of the t-score * standard error)
