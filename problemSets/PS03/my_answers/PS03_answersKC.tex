...
(Intercept)      difflog  
    0.57903      0.04167  
		...
		\begin{figure} [h]
			\includegraphics[width=\textwidth]{Question_1_scatterplot.jpeg}
		\end{figure}
...
(Intercept)      difflog  
    0.50758      0.02384  
		...
		\begin{figure} [h]
			\includegraphics[width=\textwidth]{Question_2_scatterplot.jpeg}
		\end{figure}
	    \newpage
		\item Save the residuals of the model in a separate object.
...
\begin{figure} [h]
	\includegraphics[width=\textwidth]{Question_3_scatterplot.jpeg}
\end{figure}
	...
	\noindent The numbers representing the slope and y-intercept are taken from the linear regression run in R.
		...
		\noindent In the equation, y-hat represents the predicted value of the incumbent's electoral success, and x represents the vote share of the presidential candidate of the incumbent's party.
...
-0.000000000000000005934   0.256877012700097440145 
		...
		\begin{figure} [h]
			\includegraphics[width=\textwidth]{Question_4_scatterplot.jpeg}
		\end{figure}
		
		\item Write the prediction equation.
		
		\noindent y = 0.256877012700097440145x - 0.000000000000000005934 
	\end{enumerate}
...
(Intercept)      difflog     presvote  
    0.44864      0.03554      0.25688 
		...
		\noindent $$\hat{y} = 0.44864 + 0.03554x1 + 0.25688x2 $$
